...
var PersonalAreaComponent = (function () {
    ...
    PersonalAreaComponent.prototype.ngOnInit = function () {
        ...
        setTimeout(function () {
            ...
            _this.addListener(document.getElementById('swiper-pagination1'), 'click', function () {
                var childs = document.getElementById('swiper-pagination').children;
                for (var i = 0; i < childs.length; i++) {
                    if (childs[i].classList.contains('swiper-pagination-bullet-active')) {
                        console.log(i);
                        if (i === 0) {
                            _this.selectSwiper('pension');
                        }
                        if (i === 1) {
                            _this.selectSwiper('oka');
                        }
                        if (i === 2) {
                            _this.selectSwiper('health');
                        }
                        if (i === 3) {
                            _this.selectSwiper('risk');
                        }
                    }
                }
            });
    ...
    PersonalAreaComponent.prototype.addListener = function (element, eventName, handler) {
